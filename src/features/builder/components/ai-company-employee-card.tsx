...
export function AiCompanyEmployeeCardView({ employee }: Props) {
  return (
    <Link
      ...
      data-employee-card={employee.id}
      className="group block h-full rounded-2xl border border-[var(--hq-line)] bg-[var(--hq-panel)] p-5 shadow-[0_20px_50px_-44px_rgba(18,21,28,0.45)] transition hover:border-[var(--hq-signal)] hover:shadow-[0_24px_60px_-40px_rgba(15,107,92,0.35)]"
    >
